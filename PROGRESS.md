...
**Git HEAD**: `19c4bb6`（master）— v0.10.86（第二部機安裝全鏈路根治：一粒掣下載 pyw/固定位置/桌面捷徑/tray icon + cp950 emoji crash + MT5_DATA 動態偵測 + 全面 log + 假綠燈/時區 bug — 20 commits）；TODO：數據注入選擇功能未實行（見 TODO 段）
