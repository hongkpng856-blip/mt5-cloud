...
> 🎉 2026-09-01：#152/#156/#157/#160（dropdown lag/部署第二隻/代替 dialog/剷除誤剷/冇操作開 MT5/reconnect 循環）已修（見版本表 v0.11.05）。
